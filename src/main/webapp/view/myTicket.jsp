		...
		<form role="form">
			...
			<div id="youxiaos" class="form-group"
				...
				<div class="col-xs-3"
					...
					<img src="../img/会员俱乐部.png" style="width: 80%; height: 80%;" />
				</div>
				<div class="col-xs-9"
					style="background-color:; height: 300px; border:; border-radius: 25px;">
					<div class="col-xs-9" style="text-align: left;">
						<p style="font-size: 50px; font-family: '楷体'; color: blueviolet;">闪电校园会员卡</p>
						<p style="font-size: 35px; font-family: '宋体';">&nbsp;&nbsp;&nbsp;--闪电校园旗下所有商品</p>
				...
				<div class="form-group"
					...
					<button
						style="background-color: bisque; border: hidden; border-radius: 30px; height: 60px; width: 200px; font-size: 35px; color: brown;">再来一单</button>
				</div>
			</div>
			...
			<div id="weiyongyous" class="form-group"
				...
				<div class="col-xs-3"
					style="background-color:; height: 300px; text-align: center;">
					<img src="../img/免费2.png" style="width: 80%; height: 80%;" />
				</div>
				<div class="col-xs-9"
					style="background-color:; height: 300px; border:; border-radius:;">
					<div class="col-xs-9" style="text-align: left;">
						<p style="font-size: 50px; font-family: '楷体'; color: blueviolet;">闪电校园代取卡</p>
						<p style="font-size: 35px; font-family: '宋体';">&nbsp;&nbsp;&nbsp;--代取快件、代寄快件</p>
						<p style="font-size: 35px; font-family: '黑体'; color: red;">
							<b>免单！！！</b>
						</p>
						<p style="font-size: 35px;">次卡</p>
