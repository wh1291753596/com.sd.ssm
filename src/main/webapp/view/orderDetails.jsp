	...
	<div class="hidden-lg hidden-md"
		...
		<form role="form">
			...
			<div class="form-group"
				...
				<div class="col-xs-8" style="text-align: left;">
					...
					<h2 style="font-family: 'times new roman';">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2018/02/02 14：14：14</h2>
				</div>
				<div class="col-xs-4" style="text-align: right;">
					<img src="../img/17ab041d54a1916d3148d9f9f4b76c14 (1).jpg" />
				</div>
			</div>
			<br /> <br />
			<div class="form-group"
			...
			<div class="form-group"
				...
				<button
					style="background-color: bisque; border: hidden; border-radius: 30px; height: 60px; width: 200px; font-size: 35px;">申请售后</button>
				<button
