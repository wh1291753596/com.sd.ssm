...
<script>
		...
		for (var i = 0; i < 5; i++) {
			...
			reader.onload = function(e) {
				...
				del
						.setAttribute(
								"style",
								"position: absolute; bottom: 4px; right: 0px; z-index: 99; width: 50px; height:50px;border-radius:50%;")
				//创建一个图片
				var delicon = document.createElement("img");
				//这是把删除的图标加在这个图片里面
				delicon
						.setAttribute("src",
								"http://www.jq22.com/tp/f26c324f-24db-4f08-91d6-f7ffc9ca1516.png");
				//这是删除文字
	...
	//触发事件
	function FirstImg() {
		$.DuoImgsYulan(document.getElementById("FirstfileImg").files,
				"pictures");
	}
